          ...
          <Card className="bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            <CardContent>
              <p className="text-[#546e7a]">
                By accessing or using MediBot ("the Service"), you agree to be bound by these Terms and Conditions. If you disagree with any part of the terms, you may not access the Service.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            <CardContent>
              <p className="text-[#546e7a] mb-4">
                MediBot is not a medical service and does not provide medical advice, diagnosis, or treatment. The Service is intended for medication management and reminder purposes only.
              </p>
              <p className="text-[#546e7a]">
