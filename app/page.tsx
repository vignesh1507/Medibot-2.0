            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><Link href="/demo" className="text-[#546e7a] hover:text-[#00acc1] transition-colors">Demo</Link></li>
                </ul>
              </div>
              <div>
                <h3 className="text-[#263238] font-semibold mb-4">For Healthcare</h3>
                <ul className="space-y-3">
                  <li><Link href="/providers" className="text-[#546e7a] hover:text-[#00acc1] transition-colors">Providers</Link></li>
                  <li><Link href="/hospitals" className="text-[#546e7a] hover:text-[#00acc1] transition-colors">Hospitals</Link></li>
                  <li><Link href="/pharmacies" className="text-[#546e7a] hover:text-[#00acc1] transition-colors">Pharmacies</Link></li>
                </ul>
              </div>
              <div>
                <h3 className="text-[#263238] font-semibold mb-4">Legal</h3>
                <ul className="space-y-3">
                  <li><Link href="/privacy" className="text-[#546e7a] hover:text-[#00acc1] transition-colors">Privacy</Link></li>
                  <li><Link href="/terms" className="text-[#546e7a] hover:text-[#00acc1] transition-colors">Terms</Link></li>
